...
#        'TRACING',
      ...
      'include_dirs': [
        "<!(node -p -e \"require('path').relative('.', 'src')\")",
...
#             '-lnss3',
      ...
      'sources': [
        ...
        'src/data/datachannel.cc',
        'src/data/messageevent.cc',
        'src/data/rtcdatachannelevent.cc',
        'src/event.cc',
        'src/media/capturer/filevideocapturer.cc',
        'src/media/getusermedia.cc',
        'src/media/mediastream.cc',
        'src/media/mediastreamconstraints.cc',
        'src/media/mediastreamtrack.cc',
        'src/media/recorder/capturedframeconverter.cc',
        'src/media/recorder/mediarecorder.cc',
        'src/media/recorder/mediarecorderoptions.cc',
        'src/media/recorder/mediarecorderrenderer.cc',
        'src/media/recorder/mimetype.cc',
        'src/media/recorder/rawyuvconverter.cc',
        'src/media/recorder/videoframeconverter.cc',
        ...
        'src/stats/rtcstatsresponse.cc',
        'src/stats/statsobserver.cc',
        'src/utilities.cc',
      ]
    },
    {
